<?php
/**
 * Plugin Name: SFTP to WooCommerce - Auto Minutely
 * Description: Converte arquivos SFTP em produtos WooCommerce com monitoramento automático a cada minuto
 * Version: 1.3
 * Author: DevSpacek
 * Date: 2025-03-18
 */
...
class SFTP_To_Woo_Auto {
    ...
    public function register_settings() {
        ...
        register_setting('sftp_to_woo_settings', 'sftp_auto_frequency', array(
            'default' => 'minutely' // Padrão alterado para a cada minuto
        ));
    }
            ...
            if ($next_run) {
                ...
                if ($time_diff > 0) {
                    echo '<div class="notice notice-info is-dismissible"><p>' . 
                         '<strong>Automação a cada minuto ativa!</strong> Próximo escaneamento em: ' . 
    ...
    public function render_admin_page() {
        ...
        ?>
        <div class="wrap">
            <h1>SFTP para WooCommerce (A Cada Minuto)</h1>
            ...
            <div class="notice notice-info">
                ...
                <ul style="list-style:disc;padding-left:20px;">
                    ...
                    <li>Frequência: <?php echo $auto_frequency === 'minutely' ? '<span style="color:green;font-weight:bold;">A cada minuto</span>' : esc_html($auto_frequency); ?></li>
    ...
    public function maybe_reschedule_cron($old_value, $new_value) {
        ...
        if (get_option('sftp_auto_enabled', 'yes') === 'yes') {
            ...
            $this->add_log("Agendamento atualizado: escaneamento a cada $frequency");
            $this->save_activity_log();
        }
    }
